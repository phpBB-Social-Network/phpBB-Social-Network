...
(function($) {
	$.sn.up = {
	    ...
	    init : function(opts) {
		    ...
		    $('.sn-up-viewAllFriends .viewAllLink a').click(function() {
	    ...
	    _upMenu : {
	        init : function() {
		        ...
		        $('.sn-up-menu li').each(function(idx, item) {
			        ...
			        //$subMenu.addClass('ui-menu ui-widget ui-widget-content ui-menu-icons ui-corner-bottom ui-corner-all').attr('role', 'menu');
