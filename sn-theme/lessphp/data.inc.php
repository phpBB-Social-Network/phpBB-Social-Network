...
$GLOBALS['csstidy']['predefined_templates']['default'][] = '<span class="at">';
$GLOBALS['csstidy']['predefined_templates']['default'][] = '</span> <span class="format">{</span>'."\n";
$GLOBALS['csstidy']['predefined_templates']['default'][] = '<span class="selector">';
$GLOBALS['csstidy']['predefined_templates']['default'][] = '</span>'."\n".'<span class="format">{</span>'."\n";
$GLOBALS['csstidy']['predefined_templates']['default'][] = '	<span class="property">';
$GLOBALS['csstidy']['predefined_templates']['default'][] = '</span><span class="value">';
$GLOBALS['csstidy']['predefined_templates']['default'][] = '</span><span class="format">;</span>'."\n";
$GLOBALS['csstidy']['predefined_templates']['default'][] = '<span class="format">}</span>';
$GLOBALS['csstidy']['predefined_templates']['default'][] = "\n\n";
$GLOBALS['csstidy']['predefined_templates']['default'][] = "\n".'<span class="format">}</span>'."\n\n";
$GLOBALS['csstidy']['predefined_templates']['default'][] = '	';
$GLOBALS['csstidy']['predefined_templates']['default'][] = '<span class="comment">'; // before comment
